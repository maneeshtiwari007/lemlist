				...
				<div class="card card-custom gutter-b example example-compact">
					<div class="card-header">
						...
						<div class="card-toolbar">
							<a href="{{ route('projects.view',['id'=>$editJobs->project_id]) }}" class="btn btn-light-primary font-weight-bolder mr-2">
					...
					<!--begin::Form-->
					  <form action="{{ route('projects.job.edit.post',['id'=>$editJobs->id]) }}" class="form-horizontal" enctype="multipart/form-data" method="post" id="job-form">
						@csrf
						<div class="card-body">
						<div class="row">
						  <div class="col-md-6">
...
$('body').on('click', '.add_more', function () {
   ...
   if(dataval < 11){
	   varHtml = "";
	   varHtml = '<div class="form-group row d-flex align-items-center mb-5"><label class="col-lg-2 form-control-label">Country</label><div class="col-lg-4"><input type="text" name="country_code['+dataId+'][]" placeholder="Enter Country Code" class="form-control" data-parsley-error-message="Please enter country code" required></div><div class="col-lg-4"><input type="text" name="country_weight['+dataId+'][]" id="country_weight_'+dataId+'_'+dataval+'" data-type="'+dataval+'" placeholder="Enter Country Weight Percentage between 0-100" class="form-control country_weight_val_'+dataId+' country_weight" data-id="'+dataId+'" data-parsley-type="number" data-parsley-min="1" data-parsley-max="100" data-parsley-error-message="Please enter number between 0-100" required></div><div class="col-lg-2"><button class="btn btn-info add_more" data-type="'+dataval+'" data-id="'+dataId+'" id="add_more_type_'+dataId+'" type="button">Add More</button></div></div>';
