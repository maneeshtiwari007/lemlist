		...
		<div class="d-flex align-items-center flex-wrap mr-1">
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				...
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					...
					<li class="breadcrumb-item text-muted">
						<a class="text-muted">Add Project Url Keyword</a>
					</li>
				</ul>
				<!--end::Breadcrumb-->
			</div>
			...
			<div class="col-md-12">
				...
				<div class="card card-custom gutter-b example example-compact">
					<div class="card-header">
						<h3 class="card-title">Add Project Url Keyword</h3>
						<div class="card-toolbar">
							<a href="{{ route('projects.viewurl',['id'=>$projectUrlData->project_id])}}" class="btn btn-light-primary font-weight-bolder mr-2">
							<i class="ki ki-long-arrow-back icon-xs"></i>Back</a>
							
						</div>
					</div>
					<!--begin::Form-->
					  <form action="{{ route('projects.addkeyword.post') }}" class="form-horizontal" enctype="multipart/form-data" method="post" id="project-form">
						@csrf
						<div class="card-body">
						<div class="row">
						  <div class="col-md-6">
