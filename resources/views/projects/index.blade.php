	...
	<div class="container">
		...
		<form action="" method="get">
				      ...
				      <div class="row mb-5">
						   ...
						   <div class="col-md-6">
							  <input type="text" name="project" class="form-control" value="{{ !empty($get['project']) ? $get['project'] : ''}}" placeholder="Search By Project Name,Description ..">
							</div>
							...
							<div class="col-md-2">
							<!--begin::Button-->
							<button type="submit" class="btn btn-primary font-weight-bolder search-filter">
