							  ...
							  <div class="col-md-12 select_url">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="url_name[]" placeholder="Enter Url" class="form-control" value="{{ $urlData->url_name }}">
									...
									<div class="col-md-6">
									  <div class="display_brand_keyword_{{ $j }}">
										<div class="section-title mt-5 mb-5">
										 ...
										 @if(!empty($urlData->brandKeywords->count() !=0))
											@foreach($urlData->brandKeywords as $brandKeywords)
											 <div class="form-group child_keyword">
												...
												<div class="input-group">
													<input type="text" name="brand_keyword[{{ $i }}][]" placeholder="Brand Keyword" class="form-control" value="{{ $brandKeywords->brand_keyword }}">
										 ...
										 <div class="form-group child_keyword">
											<label>Brand Keyword</label>
											<div class="input-group">
												<input type="text" name="brand_keyword[{{ $i }}][]" placeholder="Brand Keyword" class="form-control" >
												<div class="input-group-append">
									 ...
									 <div class="col-md-6">
										...
										<div class="section-title mt-5 mb-5">
										 ...
										 @if(!empty($urlData->secondaryKeywords->count() !=0))
										     ...
										     <div class="form-group child_keyword">
												...
												<div class="input-group">
													<input type="text" name="secondary_keyword[{{ $i }}][]" placeholder="Secondary Keyword" class="form-control" value="{{ $secondaryKeywords->secondary_keyword }}">
													<div class="input-group-append">
										...
										<div class="form-group child_keyword">
											<label>Secondary Keywords</label>
											<div class="input-group">
												<input type="text" name="secondary_keyword[{{ $i }}][]" placeholder="Secondary Keyword" class="form-control">
												<div class="input-group-append">
									...
									<div class="col-md-6">
									  <div class="display_brand_keyword_{{ !empty($editProjects->urls) ? $editProjects->urls->count()+1 : 1}}">
										<div class="section-title mt-5 mb-5">
										 ...
										 <div class="form-group child_keyword">
											<label>Brand Keyword</label>
											<div class="input-group">
												<input type="text" name="brand_keyword[{{ !empty($editProjects->urls) ? $editProjects->urls->count() : 0}}][]" placeholder="Brand Keyword" class="form-control" >
												<div class="input-group-append">
													  <button class="btn btn-info add_more_brand" id="add_more_brand_{{ !empty($editProjects->urls) ? $editProjects->urls->count()+1 : 1}}" data-type="1" data-parent-type="{{ !empty($editProjects->urls) ? $editProjects->urls->count()+1 : 1}}" data-id="{{ !empty($editProjects->urls) ? $editProjects->urls->count() : 0}}" type="button">Add More</button>
												</div>
											</div>
										  </div>
									  </div>
									 ...
									 <div class="col-md-6">
										...
										<div class="form-group child_keyword">
											<label>Secondary Keywords</label>
											<div class="input-group">
												<input type="text" name="secondary_keyword[{{ !empty($editProjects->urls) ? $editProjects->urls->count() : 0}}][]" placeholder="Secondary Keyword" class="form-control">
												<div class="input-group-append">
													<button class="btn btn-info add_more_secondary" id="add_more_secondary_{{ !empty($editProjects->urls) ? $editProjects->urls->count()+1 : 1}}" data-type="1" data-parent-type="{{ !empty($editProjects->urls) ? $editProjects->urls->count()+1 : 1}}" data-id="{{ !empty($editProjects->urls) ? $editProjects->urls->count() : 0}}" type="button">Add More</button>
												</div>
											</div>
										</div>
										</div>
