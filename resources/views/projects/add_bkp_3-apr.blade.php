...
$('body').on('click', '.add_more_secondary', function () {
   ...
   if(dataval < 31){
	   varHtml = "";
	   varHtml = '<div class="form-group child_keyword"><label>Secondary Keyword</label><div class="input-group"><input type="text" name="secondary_keyword['+dataId+'][]" placeholder="Secondary Keyword" class="form-control" ><div class="input-group-append"><button class="btn btn-info add_more_secondary" id="add_more_secondary_'+dataParentval+'" data-type="'+dataval+'" data-parent-type="'+dataParentval+'" type="button">Add More</button></div></div></div>';
