		...
		<div class="d-flex align-items-center flex-wrap mr-1">
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				...
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					...
					<li class="breadcrumb-item text-muted">
						<a class="text-muted">Add New project</a>
					</li>
				</ul>
				<!--end::Breadcrumb-->
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card card-custom gutter-b example example-compact">
					...
					<!--begin::Form-->
					  <form action="{{ route('projects.add.post') }}" class="form-horizontal" enctype="multipart/form-data" method="post" id="project-form">
						@csrf
						<div class="card-body">
						<div class="row">
						  <div class="col-md-6">
							<div class="form-group">
							 <label>Project Name
							  <span class="text-danger">*</span></label>
							   <input required type="text" name="project_name" placeholder="Project Name" class="form-control" data-parsley-error-message="Please enter project name">
							</div>
						  </div>
						 <div class="col-md-6">
							<div class="form-group">
								...
								<span class="text-danger">*</span></label>
								<textarea class="form-control" name="description" placeholder="Type your Descrption here ..." required data-parsley-error-message="Please enter description"></textarea>
							</div>
						 </div>
					   </div>
					   <hr>
					   <div class="row display_url">
							  ...
							  <div class="col-md-12 select_url">
								...
								<div class="row">
									<div class="col-md-6">
									  <div class="display_brand_keyword_1">
										 ...
										 <div class="form-group child_keyword">
											...
											<div class="input-group">
												...
												<div class="input-group-append">
													  <button class="btn btn-info add_more_brand" id="add_more_brand_1" data-type="1" data-parent-type="1" data-id="0" type="button">Add More</button>
												</div>
											</div>
										  </div>
									  </div>
									 ...
									 <div class="col-md-6">
										<div class="display_secondary_keyword_1" id="display_secondary_keyword">
										<div class="section-title mt-5 mb-5">
										...
										<div class="form-group child_keyword">
											...
											<div class="input-group">
												...
												<div class="input-group-append">
													<button class="btn btn-info add_more_secondary" id="add_more_secondary_1" data-type="1" data-parent-type="1" data-id="0" type="button">Add More</button>
												</div>
											</div>
										</div>
										</div>
								  ...
								  <div class="row">
								   <div class="col-12 text-right">
								      <button class="btn btn-success add_more" data-type="1" data-id="0" type="button">Add More Url</button>
									</div>
								  </div>
							   </div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<div class="input-group-append">
										<button class="btn btn-primary add_more_exact" data-type="1" type="button">Add More</button>
									</div>
								</div>
							</div>
							</div>
						  ...
						  <div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<div class="input-group-append">
										<button class="btn btn-primary add_more_partial"  data-type="1" type="button">Add More</button>
									</div>
								</div>
							</div>
							</div>
