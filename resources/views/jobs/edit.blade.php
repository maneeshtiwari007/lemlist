						  ...
						  <div class="col-md-12">
							<div class="form-group">
							 <label>Choose number of searches
							  <span class="text-danger">*</span></label>
							   <input required type="text" name="no_of_searches" placeholder="Choose number of searches between 1-1000" class="form-control" data-parsley-type="number" data-parsley-min="0" data-parsley-max="1000" data-parsley-error-message="Please enter number between 1-1000" value="{{ $editJobs->no_of_searches }}">
							</div>
						  </div>
						   ...
						   <div class="col-md-6 display_random {{ (!empty($editJobs->project_url_length_of_job == 'random') && ($editJobs->project_url_length_of_job == 'random')) ? '' : 'd-none' }}">
								...
								<div class="select">
										<select name="random_job_value" class="custom-select form-control" data-parsley-error-message="Please select a random job">
											  ...
											  <option value="168" {{ (!empty($editJobs->project_url_random_job) && ($editJobs->project_url_random_job == 168)) ? 'selected' : ''}}>7 Days</option>
											</select>
								 </div>
							</div>
