...
<div class="d-flex flex-column-fluid">
	...
	<div class="container">
		...
		<!--begin::Row-->
		<div class="row">
			<div class="col-lg-4 col-xxl-4 d-none">
				<!--begin::Mixed Widget 1-->
				...
				<div class="card card-custom bg-white-100 card-stretch gutter-b">
					...
					<div class="card-header border-0 pt-5">
						<div class="card-title">
							<div class="card-label">
								<div class="font-weight-bolder">My Jobs</div>
								<div class="font-size-sm text-muted mt-2"> {{ $getTotalMyJobs }} Jobs</div>
							</div>
						</div>
					...
					<div class="card-body d-flex flex-column px-0">
						...
						<div class="flex-grow-1 card-spacer-x">
							@if(!empty($getMyJobs[0]))
								@foreach($getMyJobs as $pro)
								...
								<div class="d-flex align-items-center mr-2">
									<div>
										...
										<div class="font-size-sm text-muted font-weight-bold mt-1">
											{{ (!empty($getUser)) ? $getUser->name : '-' }}</div>
									</div>
								</div>
						...
						<div class="flex-grow-1 card-spacer-x">
							@if(!empty($getRecentProjects[0]))
								@foreach($getRecentProjects as $pro)
							     @php $getUser = \app\User::where('id',$pro->user_id)->first(); @endphp
								<!--begin::Item-->
								<div class="d-flex align-items-center justify-content-between mb-10">
									<div class="d-flex align-items-center mr-2">
										<div>
											<a href="{{ route('projects.view',['id'=>$pro->id])}}" class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">{{ $pro->name }}</a>
											<div class="font-size-sm text-muted font-weight-bold mt-1">{{ (!empty($getUser)) ? $getUser->name : '-' }}</div>
										</div>
									</div>
									@if($pro->urls->count() != 0)
									<div class="label label-light label-inline font-weight-bold text-dark-50 py-4 px-3 font-size-base">
