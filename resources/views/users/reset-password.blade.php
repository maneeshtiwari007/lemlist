		...
		<div class="d-flex align-items-center flex-wrap mr-1">
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				...
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					...
					<li class="breadcrumb-item text-muted">
						<a class="text-muted">Reset Password</a>
					</li>
				</ul>
				<!--end::Breadcrumb-->
			</div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											  <form action="{{ route('users.reset-password.post',['id'=>$user->id]) }}" class="form-horizontal" enctype="multipart/form-data" method="post" id="user-form">
												@csrf
												<div class="card-body">
												<div class="row">
									              <div class="col-md-6">
													<div class="form-group">
													 <label>New Password
													  <span class="text-danger">*</span></label>
													   <input required type="password" name="password" id="password" placeholder="Please enter new password" class="form-control" data-parsley-error-message="Please enter new password">
													</div>
												  </div>
												 <div class="col-md-6">
													<div class="form-group">
														...
														<span class="text-danger">*</span></label>
														<input required type="password" name="confirm_password" data-parsley-equalto="#password" placeholder="Please enter confirm password" class="form-control"  >
													</div>
												 </div>
											   </div>
