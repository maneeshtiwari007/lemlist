													  ...
													  <div class="col-md-12">
														<div class="form-group">
														 <label>Access Token</label>
														   <input required type="text" placeholder="Please enter email" class="form-control"  value="{{ !empty($getConfigureCrawler->access_token	) ? $getConfigureCrawler->access_token	 : '' }}">
														</div>
													  </div>
