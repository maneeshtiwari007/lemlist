										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<div class="row w-100 align-items-center">
                                                ...
                                                <div class="col-6 text-right"> 
                                                        <a href="{{ route('dashboard') }}" class="btn btn-light-primary font-weight-bolder">
                                            ...
                                            @endif
											<!--begin::Form-->
												  <form action="{{ route('api.v1.access-token.post') }}" class="form-horizontal" enctype="multipart/form-data" method="post" id="user-form">
													@csrf
													<div class="card-body">
													  ...
													  <div class="col-md-12">
														<div class="form-group">
														 <label>Access Token</label>
														   <input required type="text" placeholder="Please enter email" class="form-control"  value="{{ !empty($getConfigureCrawler->access_token	) ? $getConfigureCrawler->access_token	 : '' }}" disabled>
														</div>
													  </div>
												...
												<input type="hidden" name="hid_config_id" value="{{ !empty($getConfigureCrawler->id	) ? $getConfigureCrawler->id	 : '' }}">
